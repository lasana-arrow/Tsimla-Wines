...
<div class="col-md-12">	
<h4 style="text-align: center; padding: 30px 0;">
<?php
single_term_title();
?> в оттенке вкуса встречается у следующих Цимлянских вин:</h4>	
	<?php
echo do_shortcode('[show_wine feature="wine_taste" value="'.$term_id.'" perrow=6]');		
?>
	</div></div>
<?php
wp_footer(); 
