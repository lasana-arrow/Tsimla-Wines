<?php
/**
 * Шаблон для вывода вин по его типу (цвету)
 * wine_color
 *
 *
 * @package WordPress
...
{ 
  ...
  echo do_shortcode('[show_wine feature="wine_color" value="'.$term_id.'" feature2="'.$feature2.'" value2="'.$value2.'" perrow="'.$num.'"]');		
}
else echo do_shortcode('[show_wine feature="wine_color" value="'.$term_id.'" perrow="'.$num.'"]');		
?>
	</div></div>
<?php
wp_footer(); 
